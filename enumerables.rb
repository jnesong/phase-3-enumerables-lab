...
def get_names(spicy_foods)
  names = spicy_foods.map {|book| book[:name]}
  puts names
end
...
def spiciest_foods(spicy_foods)
  hot = spicy_foods.filter {|food| food[:heat_level] > 5}
  puts hot
end
...
def get_spicy_food_by_cuisine(spicy_foods, cuisine)
  the_food = spicy_foods.find do |food|
...
def print_spiciest_foods(spicy_foods)
  ...
  spiciest_array = print_spicy_foods(spiciest)
end
